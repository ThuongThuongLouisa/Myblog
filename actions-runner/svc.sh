...
SVC_NAME="actions.runner.ThuongThuongLouisa-Myblog.Thuongs-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ThuongThuongLouisa-Myblog.Thuongs-MacBook-Pro)"
